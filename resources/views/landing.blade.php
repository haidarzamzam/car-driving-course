...
<html lang="en">
  <head>
    ...
    <title>Hai Car - Driving Course</title>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="contents text-center">
                <h2 class="head-title wow fadeInUp">Drive Mastery:<br>Cruising into the Future</h2>
                <div class="header-button wow fadeInUp" data-wow-delay="0.3s">
                  <a href="#schedules" class="btn btn-common">Explore</a>
                </div>
              </div>
